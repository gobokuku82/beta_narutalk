...
export function NodeComponent({ data, selected }: NodeProps) {
  ...
  return (
    <div
      className={cn(
        'rounded-input border-2 px-3 py-2 w-[180px] relative',
        style,
    ...
    >
      {isInvalidated && (
        <span
          className="absolute -top-2 -right-2 flex items-center gap-1 rounded-full bg-destructive text-destructive-foreground px-2 py-1 text-2xs font-medium"
      ...
      {isPendingModify && !isPendingDelete && (
        <span
          className="absolute -top-2 -left-2 flex items-center gap-1 rounded-full bg-accent-action text-accent-action-foreground px-2 py-1 text-2xs font-medium"
      ...
      {isPendingDelete && (
        <span
          className="absolute -top-2 -left-2 rounded-full bg-muted-foreground text-background px-2 py-1 text-2xs font-medium"
