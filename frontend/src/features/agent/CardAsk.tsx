 ...
 * 상단 컨텍스트 칩 = 카드 데이터(지표·값·기간·§S) — 에이전트에 넘기는 것과 동일(투명성).
 * 라우팅 = 문구 유도(P3, 백엔드 0) — corpus_card_actions.yaml 로 검증된 표현 사용:
 *   진단 "왜 …인지 원인 분석" → diagnose / 추천 "개선안 추천" → recommend /
 *   재검증 "재계산해서 …맞는지 검증" → measure.
 * 🔍 숫자나온방법(P5 methodology_explainer)·⚡ 해줘(MVP)는 비활성 정직 표시.
 *
 * 설계: docs/reports/카드클릭_에이전트연결_설계계획_2026-06-10.md §2·§3·§8
 */
