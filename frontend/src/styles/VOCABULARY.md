...
- **2026-06-10 v10** : Persona Tab / Feature Showcase / Showcase Media 어휘 신설 — Header 재구성 (시계 제거, OctorAD 큰 워드마크 + Data Analyst/Campaign Designer/Media Director 페르소나 탭). FeatureShowcase 신설 (데이터 표시·회의록 그래프·에이전트 워크플로우 3 카드, inline SVG 자동 애니메이션, shadow-lg ring-1 음영 강조). 향후 GIF/MP4 미디어 교체 자리 마련.
