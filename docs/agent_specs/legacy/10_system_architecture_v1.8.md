...
| 버전 | **v1.8** |
| 최종 수정일 | 2026-04-22 |
| 이전 버전 | v1.7 (2026-04-21), v1.6 (2026-04-19) |
...
`_extract_interrupt_value` 헬퍼 (ws_agent.py)가 `graph_state.tasks[0].interrupts[0].value`에서 위 payload를 추출. 상세 이벤트 스키마: `21_WEBSOCKET_PROTOCOL_v1.2.md` §7 참조.
...
| 데이터 모델 | `30_DATA_MODELS_v1.0.md` | Pydantic 모델 / Core Enum (POC 격상 + Sprint 10~13 반영) |
| API 계약 | `20_INTERFACE_CONTRACT_v1.1.md` | REST + Layer I/O + AgentState Contract |
| WS 프로토콜 | `21_WEBSOCKET_PROTOCOL_v1.2.md` | /ws/agent + /ws/hitl 전체 스펙 |
