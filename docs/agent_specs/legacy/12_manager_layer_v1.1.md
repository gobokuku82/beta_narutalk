...
| 버전 | **v1.1** |
| 최종 수정일 | 2026-04-22 |
| 선행 문서 | `10_system_architecture_v1.8.md` §4 (Manager 개요) |
| 관련 명세 | `11_main_graph_state_v1.5.md`, `21_WEBSOCKET_PROTOCOL_v1.2.md` |
...
ADALLPIN Dream Agent V2의 **Manager 계층** 단일 문서.
...
- [ ] 이 문서 §3.5 표에 행 추가
- [ ] `21_WEBSOCKET_PROTOCOL_v1.2.md` §2.2 이벤트 카탈로그에 추가
- [ ] 대시보드 `handleEvent`에 핸들러 추가
- [ ] `22_error_codes_v1.0.md` (error 이벤트인 경우)
...
- [ ] §0.2 매니저 목록 표 갱신
- [ ] §6 의존성 다이어그램 갱신
- [ ] `10_system_architecture_v1.8.md` §4.2 Manager 목록 표 갱신
