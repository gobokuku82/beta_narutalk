...
class SchemaContext:
    ...
    def get_example_queries(self) -> List[Dict[str, str]]:
        ...
        examples = [
            ...
            {
                "description": "연도별 실적 합계 (2023년 전체)",
                "sql": "SELECT `담당자`, SUM(`202301` + `202302` + `202303` + `202304` + `202305` + `202306` + `202307` + `202308` + `202309` + `202310` + `202311` + `202312`) as total_2023 FROM sales_performance GROUP BY `담당자`"
            },
            {
                "description": "연도별 실적 합계 (2024년 1-11월)",
                "sql": "SELECT `담당자`, SUM(`202401` + `202402` + `202403` + `202404` + `202405` + `202406` + `202407` + `202408` + `202409` + `202410` + `202411`) as total_2024 FROM sales_performance GROUP BY `담당자`"
            },
            {
                "description": "2023년 vs 2024년 실적 비교",
                "sql": """SELECT `담당자`,
                       SUM(`202301` + `202302` + `202303` + `202304` + `202305` + `202306` + `202307` + `202308` + `202309` + `202310` + `202311` + `202312`) as sales_2023,
                       SUM(`202401` + `202402` + `202403` + `202404` + `202405` + `202406` + `202407` + `202408` + `202409` + `202410` + `202411`) as sales_2024,
                       SUM(`202401` + `202402` + `202403` + `202404` + `202405` + `202406` + `202407` + `202408` + `202409` + `202410` + `202411`) - SUM(`202301` + `202302` + `202303` + `202304` + `202305` + `202306` + `202307` + `202308` + `202309` + `202310` + `202311` + `202312`) as growth_amount,
                       ROUND((SUM(`202401` + `202402` + `202403` + `202404` + `202405` + `202406` + `202407` + `202408` + `202409` + `202410` + `202411`) - SUM(`202301` + `202302` + `202303` + `202304` + `202305` + `202306` + `202307` + `202308` + `202309` + `202310` + `202311` + `202312`)) * 100.0 / SUM(`202301` + `202302` + `202303` + `202304` + `202305` + `202306` + `202307` + `202308` + `202309` + `202310` + `202311` + `202312`), 2) as growth_rate
